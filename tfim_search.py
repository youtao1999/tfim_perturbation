...
def main():
    ...
    parser.add_argument('-min_order', type=int, default = 2, help = 'The minimum Hamming distance between degenerate ground states')
    ...
    for index, indices in enumerate(indices_array):
        if tfim_perturbation.judge(min_order, tfim_perturbation.Hamming_array(indices, basis)):
